...
export async function runPassTwo({ bookTitle, allChaptersText, apiKey }) {
  console.log('  [pass2] Claude auditing full manuscript for repeated constructions...')
  ...
  try {
    ...
    throw new Error(`Pass 2 didn't return valid JSON: ${e.message}\n\nRaw response:\n${response.slice(0, 500)}`)
  }
}
