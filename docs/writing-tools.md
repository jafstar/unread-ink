...
**Known honest limitation:** pace measures cadence, not drama. Chapter 8 (a bureaucratic interrogation, all dialogue) measured as the *fastest* chapter in "The Boundary Shift" — faster than the cave descent or the landslide — because dialogue-heavy scenes read fast regardless of whether anything dangerous is happening. Worth knowing before trusting this as a page-turner guarantee on its own.
